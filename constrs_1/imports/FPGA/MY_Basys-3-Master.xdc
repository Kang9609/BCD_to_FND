...
set_property -dict { PACKAGE_PIN R3   IOSTANDARD LVCMOS33 } [get_ports { i_selOperatior[0] }]; #IO_L2P_T0_34               ,Sch=SW11
set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { i_selOperatior[1] }]; #IO_L5N_T0_34               ,Sch=SW12
...
# set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { A[0]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
# set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { A[1]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
# set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { A[2]  }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
# set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports { A[3]  }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 ,Sch=LED3
# set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { B[0]  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
# set_property -dict { PACKAGE_PIN U15  IOSTANDARD LVCMOS33 } [get_ports { B[1]  }]; #IO_L23P_T3_A03_D19_14        ,Sch=LED5
# set_property -dict { PACKAGE_PIN U14  IOSTANDARD LVCMOS33 } [get_ports { B[2]  }]; #IO_25_14                     ,Sch=LED6
# set_property -dict { PACKAGE_PIN V14  IOSTANDARD LVCMOS33 } [get_ports { B[3]  }]; #IO_L24N_T3_A00_D16_14        ,Sch=LED7
